function download_godot_headless() {
  GODOT_HEADLESS_URL=https://downloads.tuxfamily.org/godotengine/3.4/Godot_v3.4-stable_linux_headless.64.zip
  ...
  if [ ! -f $CACHE_DIR/godot_headless.64 ]; then
    ...
    cp Godot_v3.4-stable_linux_headless.64 $CACHE_DIR/godot_headless.64
...
function download_godot_templates() {
  GODOT_TEMPLATES_URL=https://downloads.tuxfamily.org/godotengine/3.4/Godot_v3.4-stable_export_templates.tpz
  TEMPLATES_DEST="$CACHE_DIR/editor_data/templates/3.4.stable"
